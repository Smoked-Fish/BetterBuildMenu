...
namespace BetterBuildMenu.Framework.UI
{
    public class BBM : IClickableMenu
    {
        ...
        public BBM(string builder, IMonitor modMonitor, GameLocation targetLocation = null)
        {
            Builder = builder;
            ...
            modMonitor.Log($"{builder}, {BuilderLocationName}, {TargetLocation}", LogLevel.Info);
